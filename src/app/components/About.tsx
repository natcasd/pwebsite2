...
export default function About() {
  return (
    ...
    <p className="text-sm sm:text-base md:text-lg border-black rounded-lg mb-4">
      ...
      <p className="text-sm sm:text-base md:text-lg border-black rounded-lg mb-4">
          Please <a href="#contact" className="text-gray-500 underline underline-offset-2 hover:text-black hover:underline">reach out to chat</a> if anything I am doing interests you! 
        </p>
      </div>
      </>
